...
export default class Cart extends PageManager {
    ...
    bindGiftCertificateEvents() {
        ...
        $certForm.on('submit', (event) => {
            ...
            const checkingUrl = '//randembigcommerce.randemgroup.com.au/kidstuff/application/verify-gift-certificate/';
            $.ajax({
                url: checkingUrl + code,
                type: 'GET',
                success: (response) => {
                   if (response === 'error') {
					   return alert('The gift certificate you entered couldn\'t be applied to any items in your order.');
				   } else {
